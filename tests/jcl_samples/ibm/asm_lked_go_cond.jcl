//STDFLOW   JOB   B3429X,'CHRIS MERRITT'
//ASM       EXEC  PGM=IEV90,REGION=256K,         EXECUTES ASSEMBLER
//           PARM=(OBJECT,NODECK,'LINECOUNT=60')
...
//SYSUT1    DD    DSNAME=&&WORKT1,UNIT=SYSDA,    A WORK DATA SET
//           SPACE=(CYL,(10,1))
//SYSLIN    DD    DSNAME=&&OBJOUT,UNIT=SYSDA,  THE OUTPUT OBJECT MODULE
...
//SYSLIN    DD    DSNAME=&&OBJOUT,DISP=(OLD,DELETE) INPUT OBJECT MODULE
//SYSUT1    DD    DSNAME=&&WORKT1,UNIT=SYSDA,    A WORK DATA SET
//           SPACE=(CYL,(10,1))
//SYSLMOD   DD    DSNAME=&&LMOD,UNIT=SYSDA,      THE OUTPUT LOAD MODULE
